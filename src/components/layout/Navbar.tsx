...
export const Navbar = ({ onNewPost }: NavbarProps) => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 w-full bg-black/80 backdrop-blur">
      <div className="flex items-center justify-between px-4 md:px-16 py-[26px] h-[81px] max-w-[1440px] mx-auto w-full">
